...
FixEnforce2DBD::FixEnforce2DBD(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg),
  flist(NULL)
{
...
void FixEnforce2DBD::setup(int vflag)
{
...
void FixEnforce2DBD::min_setup(int vflag)
{
  post_force(vflag);
}
...
void FixEnforce2DBD::post_force(int /*vflag*/)
{
  double **x = atom->x;
  double **v = atom->v;
  double **f = atom->f;
...
void FixEnforce2DBD::post_force_respa(int vflag, int /*ilevel*/, int /*iloop*/)
{
  post_force(vflag);
}
...
void FixEnforce2DBD::min_post_force(int vflag)
{
  post_force(vflag);
}
